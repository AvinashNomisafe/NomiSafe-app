...
const LifeInsuranceScreen: React.FC = () => {
  const navigation = useNavigation<LifeInsuranceScreenNavigationProp>();
  ...
  const loadPolicies = async () => {
    try {
      ...
      const data = await getPolicies('LIFE');
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          <Text style={styles.icon}>🛡️</Text>
          <Text style={styles.pageTitle}>Life Insurance</Text>
